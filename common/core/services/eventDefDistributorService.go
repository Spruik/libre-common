...
func (s *eventDefDistributorService) DistributeEventDef(eqName string, eventDef *domain.EventDefinition, computedPayload map[string]interface{}) error {
	return s.port.DistributeEventDef(eqName, eventDef, computedPayload)
}
